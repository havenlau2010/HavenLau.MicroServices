...
using HavenLau.Core.Common.Helper;
    ...
    public class SeedData
    {
        ...
        private static void EnsureSeedData(ConfigurationDbContext context)
        {
            if (!context.Clients.Any())
            {
                ...
                foreach (var client in Config.DBConfig.GetClients().ToList())
                {
            ...
            if (!context.IdentityResources.Any())
            {
                ...
                foreach (var resource in Config.DBConfig.GetIdentityResources().ToList())
                {
            ...
            if (!context.ApiResources.Any())
            {
                ...
                foreach (var resource in Config.DBConfig.GetApiResources().ToList())
                {
